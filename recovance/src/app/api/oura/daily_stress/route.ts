...
export async function POST(req: NextRequest) {
  try {
    ...
    const url = `https://api.ouraring.com/v2/usercollection/daily_stress?start_date=${start_date}&end_date=${end_date}`;
    ...
    console.error("Error fetching daily stress data:", error);
    return NextResponse.json(
